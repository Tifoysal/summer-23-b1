...
class HomeController extends Controller
{
  ...
  public function verifyOtp(Request $request)
  {
    ...
    $checkCustomerExist = Customer::where('otp', $request->otp)->first();
    if ($checkCustomerExist) 
    {

      if ($checkCustomerExist->otp_expired_at >= now()) 
      {
        if ($checkCustomerExist->email_verified_at == null) 
        {
          //verify here
      ...
      Toastr::error('OTP Invalid or Customer not found.');
      return redirect()->back();
    }
  }
